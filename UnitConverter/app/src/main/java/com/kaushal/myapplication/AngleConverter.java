...
public class AngleConverter extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"rad", "deg(°)", "min(')","second","grad","circle","6400 mil","6000 mil"};
    ...
    public void sendAngle(View view){
        ...
        double unit[] = {1,57.29578,3437.74677,206264.806,63.661977,155.740772,.159155,1018.59164,954.929659};
        String[] names = new String[]{"rad", "deg(°)", "min(')","second","grad","circle","6400 mil","6000 mil"};
