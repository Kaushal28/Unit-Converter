...
public class ForceConverter extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"dyne", "N", "daN","kN","gf","kgf","lbf"};
    ...
    public void sendForce(View view){
        ...
        double unit[] = {100000,1,.1,.001,101.971621,.101971621,.224809};
        String[] names = new String[]{"dyne", "N", "daN","kN","gf","kgf","lbf"};
        for(int i=0;i<7;i++){
