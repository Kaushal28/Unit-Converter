...
public class WeightConverter extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"µg", "mg", "g","kg","lb(pound)","oz","grain","tonne","ton(UK)","stone(UK)","carat","tola","ratti"};
    ...
    public void sendWeight(View view){
        ...
        double unit[] = {1000000000,1000000,1000,1,2.204623,35.273962,15432.3584,.001,.000984,.157473,5000,85.735324,5494.50549};
        String[] names = new String[]{"µg", "mg", "g","kg","lb(pound)","oz","grain","tonne","ton(UK)","stone(UK)","carat","tola","ratti"};
