...
public class TimeConverter extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"ms", "sec", "min","hour","day","week","month","year"};
    ...
    public void sendTime(View view){
        ...
        double unit[] = {3600000,3600,60,1,.0416667,.005952,.00137,.000114};
        String[] names = new String[]{"ms", "sec", "min","hour","day","week","month","year"};
        for(int i=0;i<8;i++){
