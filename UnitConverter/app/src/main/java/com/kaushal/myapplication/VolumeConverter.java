...
public class VolumeConverter extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"ml(cc)", "dl", "l","cm³","in³","ft³","yd³","gal(UK)","gal(US)","bbl","m³"};
    ...
    public void sendVolume(View view){
        ...
        double unit[] = {1000,10,1,1000,61.023744,.035315,.001308,.219969,.264172,.00629,.001};
        String[] names = new String[]{"ml(cc)", "dl", "l","cm³","in³","ft³","yd³","gal(UK)","gal(US)","bbl","m³"};
