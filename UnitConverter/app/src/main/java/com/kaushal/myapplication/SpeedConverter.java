...
public class SpeedConverter extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"m/s", "ft/s", "m/min","ft/min","km/min","km/h","mile/h","knot","mach"};
    ...
    public void sendSpeed(View view){
        ...
        double unit[] = {1,3.28084,60,196.850394,.06,3.6,2.236936,1.943844,0.002941};
        String[] names = new String[]{"m/s", "ft/s", "m/min","ft/min","km/min","km/h","mile/h","knot","mach"};
        for(int i=0;i<9;i++){
