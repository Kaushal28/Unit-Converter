...
public class DataConverter extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"bit", "Byte", "KiB","MiB","GiB","TiB","PiB","kbit/s","Mbit/s","Gbit/s","packet","block"};
    ...
    public void sendData(View view){
        ...
        double unit[] = {8388608,1048576,1024,1,.000977,.00000095367,.00000000093132,8388.608,8.388608,.008389,8192,2048};
        String[] names = new String[]{"bit", "Byte", "KiB","MiB","GiB","TiB","PiB","kbit/s","Mbit/s","Gbit/s","packet","block"};
        ...
        for(int i=0;i<12;i++){
            ...
            BigDecimal bd1;
            bd1 = bd.setScale(20, RoundingMode.DOWN);
