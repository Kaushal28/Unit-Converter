...
public class AreaConverter extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"mm²", "cm²", "m²","ha","km²","in²","ft²","yd²","Gunta","Cent","Acre"};
    ...
    public void sendData1(View view){
        ...
        double unit[] = {1000000,10000,1,.0001,.000001,1550.0031,10.76391,1.19599,.009884,.024711,.000247};
        String[] names = new String[]{"mm²", "cm²", "m²","ha","km²","in²","ft²","yd²","Gunta","Cent","Acre"};
