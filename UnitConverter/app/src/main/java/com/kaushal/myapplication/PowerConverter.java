...
public class PowerConverter extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"W", "kW", "MW","kcal/s","kcal/h","HP","ps","BTU/h","TR","dBm"};
    ...
    public void sendPower(View view){
        ...
        double unit[] = {1,.001,.000001,.000239,.860421,.001341,.00136,3.412142,.000285,30};
        String[] names = new String[]{"W", "kW", "MW","kcal/s","kcal/h","HP","ps","BTU/h","TR","dBm"};
